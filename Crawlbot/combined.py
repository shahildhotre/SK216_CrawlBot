# -*- coding: utf-8 -*-
"""
Created on Mon Aug  3 01:00:23 2020
...
if web_type == 'darkweb':
    ...
    try :
        ...
        torlinks = suc.TordexSeedCollector()
                ...
                if is_alive(url):
                    ...
                    try :
                        ...
                        for ind in df_a_score.index:
                            ...
                            if df_a_score['Final Score'][ind] > threshold and df_a_score['Final Score'][ind] not in found:
